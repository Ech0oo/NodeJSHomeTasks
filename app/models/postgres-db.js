...
const dbconnection = new Sequelize(dbConfig.dbpostgres.database, dbConfig.dbpostgres.username, dbConfig.dbpostgres.password, {
    host: "localhost",
    dialect: "postgres"
});
...
export {dbconnection, Products, Users, Reviews};